...
class GradientDescent
  def initialize(args)
    @options = { folder: "matrices2", epsilon: 0.0001 }
    OptionParser.new do |opts|
      opts.banner = "Usage: gradient_descent.rb [options]"
  ...
  def build_matrices
    ...
    unless @matrix_A.simetric?
      puts "Matrix is not simetric, are you sure you want to continue? [Y/n]"
...
GradientDescent.new(ARGV).solve
